export const INITIAL_PORTFOLIO_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      github_url: "https://github.com/Mudassar-23/Word-Plugin",
      live_url: "",
      description:
        "This project is a Microsoft 365 Word Add-in integrated with a FastAPI-based central backend. It supports Word Desktop and Word for the Web using Office.js for document interaction and automation. Users can extract, manage, and insert template tags such as `<<Employee Name>>` and `<<Order ID>>`. The system supports document scanning, JSON-based template rendering, and in-place document preview. Documents are stored in a well-structured format on a centralized backend server for easy management and retrieval. The project also provides XML tag extraction, DOCX template merging, REST APIs, database storage, and Docker-based deployment.",
      tag: "Office 365 · Automation · WEB",
      lang: "OFFICE.JS, JavaScript, HTML, CSS, FastAPI, Python, PostgreSQL, SQLite, Docker",
      stars: 0,
      image_url: "/uploads/word.png",
      caption: "Word Plugin",
      sort_order: 2,
    },
    {
  ...
  media: [
    ...
    },
    {
      id: 9,
      name: "Microsoft Word Plugin",
      caption: "Microsoft Word Plugin",
      image_url: "/uploads/word.png",
      video_url: "/videos/plugin.mp4",
      project_id: 9,
      url: "https://github.com/Mudassar-23/Word-Plugin",
      sort_order: 2,
    },
    {
      id: 10,
  ...
  certifications: [
    ...
    },
    {
      ...
      issue_date: "",
      pdf_url: "/certs/LeadershipFoundations.pdf",
      sort_order: 7,
    },
    {
      id: 9,
    ...
    },
    {
      ...
      issuer: "LinkedIn Learning",
      issue_date: "",
      pdf_url: "/certs/ManagingTeams.pdf",
      sort_order: 9,
    },
    {
      id: 11,
